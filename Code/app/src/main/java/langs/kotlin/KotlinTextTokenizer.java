...
public class KotlinTextTokenizer {
    ...
    protected static void doStaticInit() {
        sKeywords = new String[]{
                ...
                "double", "final", "float", "for", "if", "Int", "long", "String", "new",
                "public", "private", "protected", "package", "return", "static",
                "short", "super", "when", "else", "volatile", "synchronized", "strictfp",
                "goto", "continue", "break", "transient", "fun", "try", "catch",
                "finally", "while", "is", "default", "const", "enum", "extends",
                "implements", "import", "instanceof", "interface", "native",
                "this", "throw", "throws", "true", "false", "null", "var", "val", "companion",
                "object", "data", "override", "lateinit", "as", "in", "typealias", "typeof",
                "constructor", "delegate", "dynamic", "actual", "annotation", "crossinline",
                "expect", "external", "infix", "inline", "inner", "noinline", "open",
                "operator", "out", "reified", "sealed", "suspend", "tailrec", "vararg"
        };
        Tokens[] sTokens = new Tokens[]{
                Tokens.ABSTRACT, Tokens.ASSERT, Tokens.BOOLEAN, Tokens.BYTE, Tokens.CHAR, Tokens.CLASS, Tokens.DO,
                Tokens.DOUBLE, Tokens.FINAL, Tokens.FLOAT, Tokens.FOR, Tokens.IF, Tokens.INT, Tokens.LONG, Tokens.STRINGKEYWORD, Tokens.NEW,
                Tokens.PUBLIC, Tokens.PRIVATE, Tokens.PROTECTED, Tokens.PACKAGE, Tokens.RETURN, Tokens.STATIC,
                Tokens.SHORT, Tokens.SUPER, Tokens.WHEN, Tokens.ELSE, Tokens.VOLATILE, Tokens.SYNCHRONIZED, Tokens.STRICTFP,
                Tokens.GOTO, Tokens.CONTINUE, Tokens.BREAK, Tokens.TRANSIENT, Tokens.FUN, Tokens.TRY, Tokens.CATCH,
                Tokens.FINALLY, Tokens.WHILE, Tokens.IS, Tokens.DEFAULT, Tokens.CONST, Tokens.ENUM, Tokens.EXTENDS,
                Tokens.IMPLEMENTS, Tokens.IMPORT, Tokens.INSTANCEOF, Tokens.INTERFACE, Tokens.NATIVE,
                Tokens.THIS, Tokens.THROW, Tokens.THROWS, Tokens.TRUE, Tokens.FALSE, Tokens.NULL, Tokens.VAR, Tokens.VAL, Tokens.COMPANION,
                Tokens.OBJECT, Tokens.DATA, Tokens.OVERRIDE, Tokens.LATEINIT, Tokens.AS, Tokens.IN, Tokens.TYPEALIAS, Tokens.TYPEOF,
                Tokens.CONSTRUCTOR, Tokens.DELEGATE, Tokens.DYNAMIC, Tokens.ACTUAL, Tokens.ANNOTATION, Tokens.CROSSINLINE,
                Tokens.EXPECT, Tokens.EXTERNAL, Tokens.INFIX, Tokens.INLINE, Tokens.INNER, Tokens.NOINLINE, Tokens.OPEN,
                Tokens.OPERATOR, Tokens.OUT, Tokens.REIFIED, Tokens.SEALED, Tokens.SUSPEND, Tokens.TAILREC, Tokens.VARARG
        };
